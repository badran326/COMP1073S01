		...
		let linkPragraph = document.querySelector('section p');
		linkPragraph.appendChild(text);
		...
		section.appendChild(linkPragraph);
		/* STEP 4b: Remove the node */
		//section.removeChild(linkPragraph);
		linkPragraph.remove();
